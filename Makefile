...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2018/03/02 18:18:40 by amwangal          #+#    #+#              #
#    Updated: 2018/03/21 18:57:19 by amwangal         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_memccpy.c ft_memset.c ft_putnbr_fd.c ft_strcmp.c ft_striteri.c ft_strncat.c ft_strrchr.c ft_toupper.c ft_table_delete.c ft_str_split.c \
ft_find_next.c 
...
ft_memccpy.o ft_memset.o ft_putnbr_fd.o ft_strcmp.o ft_striteri.o ft_strncat.o ft_strrchr.o ft_toupper.o ft_table_delete.o ft_str_split.o \
ft_find_next.o
